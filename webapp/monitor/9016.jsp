	...
	<table id="customers" align="center">
		...
		<c:forEach items="${list }"  step="3" >
			<tr>
				...
				<td>
					<a target="_blank" href="http://${city.host}:${city.port16 }/<%=arg%>"><c:out value="${city.citynamecn }"/></a>
					<br/>
					<iframe name="${city.citynamecn }" src="http://${city.host}:${city.port16 }/<%=arg%>"  height=250 width=100% style="border:1px solid #D3D3D3;">No Support Frame </iframe>
				</td>
				</c:forEach>
