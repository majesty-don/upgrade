...
<body class="easyui-layout">
				...
				<table align="center" id="gridlist"  loadMsg='正在处理,请稍候...'>
					<thead>
						<tr>
							...
							<th field="name" width="10%" align="center">城市名称</th>
							<th field="remote" width="10%" align="center">城市地址</th>
							<th field="port22" width="10%" align="center">SSH端口</th>
							<th field="port10" width="10%" align="center">WEB端口</th>
							<th field="port15" width="10%" align="center">RECV端口</th>
							<th field="port16" width="10%" align="center">SERV端口</th>
							<th field="port17" width="10%" align="center">升级端口</th>
							<th field="username" width="10%" align="center">用户帐号</th>
							<th field="password" width="10%" align="center">用户密码</th>
	...
	<div id="AddInfo" icon="icon-add" title="添加" style="display: none;">
		<div
			style="width: 460px; height: 100px; font-size: 12px; color: Black;">
			<table
				style="width: 450px; height: 100px; margin-left: 20px; margin-top: 15px;">
				<tr>
					<td valign="middle" style="width: 120px">城市名称：</td>
					<td valign="middle" style="width: 300px"><input id="cityname"
						type="text" style="width: 260px" /></td>
				</tr>
				<tr>
					<td valign="top" style="width: 120px">城市url：</td>
					<td valign="middle" style="width: 300px"><input id="url"
						type="text" style="width: 260px" /></td>
				</tr>
				<tr>
					<td valign="top"width:120px">端口号：</td>
					<td valign="middle" style="width: 300px"><input id="port"
						type="text" style="width: 260px" /></td>
				</tr>
			</table>
		</div>
	...
	<div id="ModifyInfo" icon="icon-edit" title="修改"
		style="font-size: 10; display: none;">
		<div>
			<table
				style="width: 450px; height: 100px; margin-left: 20px; margin-top: 15px;">
				<tr>
					<td valign="middle" style="width: 120px">城市名称：</td>
					<td valign="middle" style="width: 300px"><input id="cityname1"
						type="text" style="width: 260px" /></td>
				</tr>
				<tr>
					<td valign="top" style="width: 120px">城市url：</td>
					<td valign="middle" style="width: 300px"><input id="url1"
						type="text" style="width: 260px" /></td>
				</tr>
				<tr>
					<td valign="top" style="width: 120px">端口号：</td>
					<td valign="middle" style="width: 300px"><input id="port1"
						type="text" style="width: 260px" /></td>
				</tr>
			</table>
		</div>
