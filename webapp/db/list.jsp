...
<body class="easyui-layout" data-options="fit : true,border : false" >
  <div id="home" title="数据库信息" region="center" data-options="fit : true" >
	<table align="center" id="gridlist"  loadMsg='正在处理,请稍候...'>
		<thead>
			<tr>
				...
				<th field="cityNameCn" width="10%" align="center">中文名</th>
				<th field="cityNameEn" width="10%" align="center">英文名</th>
				<th field="dburl" width="30%" align="center">URL</th>
				<th field="dbusername" width="10%" align="center">数据库用户名</th>
				<th field="dbpassword" width="10%" align="center">数据库密码</th>
				<th field="gpsTableType" width="10%" align="center">GPS表类型</th>
